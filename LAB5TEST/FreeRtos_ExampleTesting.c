...
void vStartLED1(void* pvInput){
    ...
    TickType_t xDelay = (uint32_t) 1000;    //1000 s delay
...
void vStartLED2(void* pvInput){
    ...
    TickType_t xDelay = (uint32_t) 2000;
...
void vStartLED3(void* pvInput){
    ...
    TickType_t xDelay = (uint32_t) 3000;
...
// declaring our loca vaiable for the LED4 function.
    TickType_t xDelay = (uint32_t) 4000;
...
void vLightLED1(void* pvInput){
    ...
    while(1){
       ...
       // If BUTTON PRESSED and is the Left(PJ0) button, light LED1 for 10 milli seconds
...
// Enabling UART0 PERIPHERAL
    ...
    //Create tasks
    xTaskCreate(vStartLED1, "LED1 Task", configMINIMAL_STACK_SIZE, (void*) 0, tskIDLE_PRIORITY + 2, &xHandleBlink1);
    xTaskCreate(vStartLED2, "LED2 Task", configMINIMAL_STACK_SIZE, (void*) 0, tskIDLE_PRIORITY + 2, &xHandleBlink2);
    xTaskCreate(vStartLED3, "LED3 Task", configMINIMAL_STACK_SIZE, (void*) 0, tskIDLE_PRIORITY + 2, &xHandleBlink3);
    xTaskCreate(vStartLED4, "LED4 Task", configMINIMAL_STACK_SIZE, (void*) 0, tskIDLE_PRIORITY + 2, &xHandleBlink4);
    xTaskCreate(vLightLED1, "KeepL1 Lit", configMINIMAL_STACK_SIZE, (void*) 0, tskIDLE_PRIORITY + 3, &xHandleButton1);
    xTaskCreate(vLightLED2, "KeepL2 Lit", configMINIMAL_STACK_SIZE, (void*) 0, tskIDLE_PRIORITY + 3, &xHandleButton2);
